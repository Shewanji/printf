...
/**
 * parser - This function parses a string with format specifiers and
 *          calls the corresponding function for each specifier.
 *
 * @format: string to be parsed
 * @funct_list: array of structs with function pointers and specifiers
 * @args: va_list of arguments to be used by the functions
 *
